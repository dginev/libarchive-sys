...
pub type archive_write_callback =
    extern "C" fn(arg1: *mut Struct_archive,
                  _client_data: *mut c_void,
                  _buffer: *const c_void, _length: size_t) -> ssize_t;
...
pub type archive_switch_callback =
    extern "C" fn(arg1: *mut Struct_archive,
                  ...
                  _client_data2: *mut c_void) -> c_int;

//pub enum archive_result {
...
extern "C" {
     ...
     pub fn archive_read_open_memory(arg1: *mut Struct_archive,
                                    buff: *mut c_void, size: size_t)
     -> c_int;
     pub fn archive_read_open_memory2(a: *mut Struct_archive,
                                     buff: *mut c_void, size: size_t,
                                     read_size: size_t) -> c_int;
     pub fn archive_read_open_fd(arg1: *mut Struct_archive, _fd: c_int,
                                _block_size: size_t) -> c_int;
     pub fn archive_read_open_FILE(arg1: *mut Struct_archive, _file: *mut FILE)
     -> c_int;
     ...
     pub fn archive_write_open_file(arg1: *mut Struct_archive,
                                   _file: *const c_char)
     -> c_int;
     pub fn archive_write_open_FILE(arg1: *mut Struct_archive, arg2: *mut FILE)
     -> c_int;
     ...
     pub fn archive_error_string(arg1: *mut Struct_archive)
     -> *const c_char;
     pub fn archive_format_name(arg1: *mut Struct_archive)
     -> *const c_char;
     pub fn archive_format(arg1: *mut Struct_archive) -> c_int;
     pub fn archive_clear_error(arg1: *mut Struct_archive) -> ();
     pub fn archive_set_error(arg1: *mut Struct_archive, _err: c_int,
                             fmt: *const c_char, ...) -> ();
